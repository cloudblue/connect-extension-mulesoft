...
public class ApproveTierConfigRequestTestCase extends BaseMuleFlowTestCase {
    ...
    public ApproveTierConfigRequestTestCase(String flow) {
        this.flow = flow;
    }

    @Override
    protected String getConfigFile() {
        return "test-mule-config-approve-tier-config-request.xml";
    }
