...
public class FailTierConfigRequestTestCase extends BaseMuleFlowTestCase {
    ...
    public FailTierConfigRequestTestCase(String flow) {
        this.flow = flow;
    }

    @Override
    protected String getConfigFile() {
        return "test-mule-config-fail-tier-config-request.xml";
    }

    @Test
    public void testFailTierConfigRequestCase() throws Exception {
