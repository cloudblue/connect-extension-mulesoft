...
public class CreateTierAccountRequestTestCase extends BaseMuleFlowTestCase {
    ...
    public CreateTierAccountRequestTestCase(String flow) {
        this.flow = flow;
    }

    @Override
    protected String getConfigFile() {
        return "test-mule-config-create-tier-account-request.xml";
    }

    @Test
    public void testCreateTierAccountRequestCase() throws Exception {
