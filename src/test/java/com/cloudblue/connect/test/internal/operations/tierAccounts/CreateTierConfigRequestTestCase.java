...
public class CreateTierConfigRequestTestCase extends BaseMuleFlowTestCase {
    ...
    public CreateTierConfigRequestTestCase(String flow) {
        this.flow = flow;
    }

    @Override
    protected String getConfigFile() {
        return "test-mule-config-create-tier-config-request.xml";
    }

    @Test
    public void testCreateTierConfigRequestCase() throws Exception {
