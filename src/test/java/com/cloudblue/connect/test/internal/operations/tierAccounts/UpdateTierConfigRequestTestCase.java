...
public class UpdateTierConfigRequestTestCase extends BaseMuleFlowTestCase {
    ...
    public UpdateTierConfigRequestTestCase(String flow) {
        this.flow = flow;
    }

    @Override
    protected String getConfigFile() {
        return "test-mule-config-update-tier-config-request.xml";
    }
