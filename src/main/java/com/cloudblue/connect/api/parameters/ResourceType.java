...
public enum ResourceType {
    REQUEST, ASSET, SUBSCRIPTION_REQUEST, SUBSCRIPTION_ASSET, TIER_ACCOUNT, TIER_ACCOUNT_VERSION,

    TIER_ACCOUNT_REQUEST, TIER_CONFIG_REQUEST, TIER_CONFIG, PRODUCT, PRODUCT_TEMPLATE,
